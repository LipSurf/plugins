  ...
  commands: [
    {
      ...
      global: !0,
      match: "google *",
      pageFn: (transcript, [rawTs, normTs]) => {
...
allPlugins.Google = (() => ({...PluginBase, commands: {Search: {pageFn: (transcript, [rawTs, normTs]) => {
  window.location.href = `https://www.google.com/search?q=${rawTs}`;
}}, "I'm Feeling Lucky": {pageFn: (transcript, [rawTs, normTs]) => {
  window.location.href = `https://www.google.com/search?btnI=I%27m+Feeling+Lucky&q=${rawTs}`;
