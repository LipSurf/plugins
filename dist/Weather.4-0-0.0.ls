  ...
  commands: [
    {
      ...
      pageFn: async (transcript, q) => {
        ...
        return curLang in weatherForLang ? chosenLang = curLang : shortenedLang in weatherForLang ? chosenLang = shortenedLang : chosenLang = "en", weatherForLang[chosenLang](q);
      }
    }
  ]
};
