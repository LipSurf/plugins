...
TopSites_default.languages.ja = {
  niceName: "トップサイト",
  description: "人気のウェブサイトへのショートカットです。",
  authors: "Miko, Hanna, Hiroki Yamazaki",
  commands: {
    Youtube: {
      name: "Youtube",
      match: ["ゆーちゅーぶ", "youtube"]
    },
    Wikipedia: {
      name: "Wikipedia",
      match: ["うぃきぺでぃあ", "wikipedia"]
    },
    Facebook: {
      name: "Facebook",
      match: ["ふぇいすぶっく", "ふぇーすぶっく", "facebook"]
    },
    Twitter: {
      name: "Twitter",
      match: ["ついったー", "twitter"]
    ...
    "New York Times": {
      name: "New York Times",
      match: ["にゅーよーくたいむず", "にゅーよーくたいむす", "new york times"]
    },
    Github: {
      name: "Github",
      match: ["ぎっとはぶ", "github"]
    ...
    "Hacker News": {
      name: "Hacker News",
      match: ["はっかーにゅーす", "hacker news"]
    },
    "Product Hunt": {
      name: "Product Hunt",
      match: ["ぷろだくとはんと", "product hunt"]
    }
  }
};
TopSites_default.languages.ru = {
...
allPlugins.TopSites = (() => ({...PluginBase, commands: {YouTube: {pageFn: async () => {
  window.location.href = "https://www.youtube.com/";
}}, Wikipedia: {pageFn: async () => {
  window.location.href = "https://www.wikipedia.org/";
}}, Facebook: {pageFn: async () => {
  window.location.href = "https://www.facebook.com/";
}}, Twitter: {pageFn: async () => {
  window.location.href = "https://twitter.com/";
}}, Instagram: {pageFn: async () => {
  window.location.href = "https://www.instagram.com/";
}}, Amazon: {pageFn: async () => {
  window.location.href = "https://www.amazon.com/";
}}, Ebay: {pageFn: async () => {
  ...
  window.location.href = "https://vk.com";
}}, Netflix: {pageFn: async () => {
  window.location.href = "https://www.netflix.com";
}}, Twitch: {pageFn: async () => {
  window.location.href = "https://twitch.tv";
}}, "New York Times": {pageFn: async () => {
  window.location.href = "https://www.nytimes.com";
}}, Github: {pageFn: async () => {
  window.location.href = "https://github.com/";
}}, "Product Hunt": {pageFn: async () => {
  window.location.href = "https://www.producthunt.com";
}}}}))();
LS-SPLIT// dist/tmp/TopSites/TopSites.js
allPlugins.TopSites = (() => ({...PluginBase, commands: {YouTube: {pageFn: async () => {
