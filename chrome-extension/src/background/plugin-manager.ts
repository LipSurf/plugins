...
export class PluginManager extends StoreSynced {
    ...
    static async digestNewPlugin(id: string, version: string): Promise<ILocalPluginData> {
        ...
        let autoGenerated = `${id}Plugin.Plugin.getOption = function(name) { return PluginBase.getOption('${id}', name); };
                             ${id}Plugin.Plugin.setOption = function(name, val) { return PluginBase.setOption('${id}', name, val); };`;
        ...
        return {
            ...
            languages: ["en", ...<LanguageCode[]>Object.keys(plugin.languages)],
